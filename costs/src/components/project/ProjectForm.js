...
function ProjectForm({ btnText,  handleSubmit, projectData }) { 
    ...
    return (
        <form onSubmit={submit} className={styles.form}>
            ...
            <Input type='number' text='Orçamento do Projeto' name='budget' placeholder='Orçamento do Projeto' handleOnChange={handleChange} value={project.budget ? project.budget : ''} />
